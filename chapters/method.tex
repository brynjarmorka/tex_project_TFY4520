...
\brynjar{Uncertainties? Also get this data properly from AZtec.}
...
% The calibration values from AZtec is referred to as uncalibrated. % Not true
\brynjar{Uncertainties from HyperSpy?}
...
NumPy 1.22.4 is used for calculations, SciPy 1.9.0 for fitting and peak finding, and Plotly 5.10.0 for plotting \ton{do I reference these packages?}.
...
\ton{This is getting argumentative, but it is the base for the decision and not really anything with the end results. It is just to reproduce. OK?}
