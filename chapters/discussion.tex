...
% \begin{quote}
%     \cverb|s = hs.load(<filepath>, signal="EDS_TEM")

%     \cverb|s.set_elements(<element_list>)
% \end{quote}
\begin{lcverbatim}
...
% \begin{quote}
%     \cverb|bw = s1.estimate_background_windows(windows_width=<number>)

%     \cverb|iw =  s1.estimate_integration_windows(windows_width=<number>)
% \end{quote}
\begin{lcverbatim}
...
% \begin{quote}
%     \cverb|s.plot(xray_lines=True, background_windows=bw, integration_windows=iw)
% \end{quote}
...
% \begin{quote}
%     \cverb|s_i = s.get_lines_intensity(background_windows=bw, integration_windows=iw)

%     \cverb|k_factors = [<k-factor 1>, <k-factor 2>]  

%     \cverb|quant = s.quantification(s_i, method='CL', factors=k_factors)

%     \cverb|print(f'E1: {quant[0].data[0]:.2f} \%, E1: {quant[1].data[0]:.2f} \%')
% \end{quote}
...
% \begin{quote}
%     \cverb|s = s.isig[<zero_peak_last_index>:]

%     \cverb|m = s.create_model(auto_background=False)

%     \cverb|m.add_polynomial_background(order=12)

%     \cverb|m.add_family_lines(<list_of_element_lines>)
...
The lines above removes the zero peak, create a model from the \cverb|signal| s, adds a 12th order polynomial, add the lines of the elements in the \cverb|signal|, and plot the model.
...
% \begin{quote}
%     \cverb|m_i = m.get_lines_intensity()
...
%     \cverb|m.calibrate_energy_axis(calibrate='scale')

%     \cverb|m.calibrate_energy_axis(calibrate='offset')
