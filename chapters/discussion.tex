...
% % Is this now redundant with the previous section?
...
It might be that the calibration of the SEM APREO EDS detector was set e.g. upon installation, and have not beed changed since then.
...
The peaks need a good signal-to-noise ratio, becasue the fit needs to be good to find the correct peak position.
...
If the problem was lower singal-to-noise ratio of Mo K$\alpha$, the problem could have been solved by using a longer counting time.
...
If this woud be true, the Ga K$\alpha$ peak would be a overlapping peak with a broadening at the right side, but as seen in \cref{fig:results:Ga-K}, this is not the case.
