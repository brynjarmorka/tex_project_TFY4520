...
% TODO: comment the four figures below in the text
...
% HYperSpy and X-ray Data Booklet are not the same. HS more empirical?
...
% Mo L$\alpha$ a, but its weight is 0.11 and its is just -3 eV from the L$\alpha$ line. 
% XRB list Mo K$\beta$ as three lines, with energies 19.59, 19.61, and 19.97 keV, and the weights are 0.08, 0.15, and 0.03, respectively.
