...
\begin{figure}[h] % p is to get their own page for floats
    \centering
...
\begin{table}[h]
    ...
    \begin{tabular}{ccccc}
        V$_\textnormal{acc}$ [kV] & Line      & Ga k-factor & As k-factor & $k_\textnormal{GaAs} = k_\textnormal{Ga}/k_\textnormal{As}$ \\ %Ga / As k-factor ratio \\
        \hline
