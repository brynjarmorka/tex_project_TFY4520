...
The difference between the listed lines in the X-ray Booklet and the lines in the HyperSpy database are discussed later, as it can be confusing.
...
The second figure is a zoomed in version of the first figure, to better visualize the background and sum peaks, and also show the K-line sum peaks.
